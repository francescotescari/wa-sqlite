...
["_RegisterExtensionFunctions","_main","_malloc","_free","_sqlite3_bind_blob","_sqlite3_bind_double","_sqlite3_bind_int","_sqlite3_bind_int64","_sqlite3_bind_null","_sqlite3_bind_parameter_name","_sqlite3_bind_parameter_count","_sqlite3_bind_text","_sqlite3_changes","_sqlite3_clear_bindings","_sqlite3_close","_sqlite3_column_blob","_sqlite3_column_bytes","_sqlite3_column_count","_sqlite3_column_double","_sqlite3_column_int","_sqlite3_column_int64","_sqlite3_column_name","_sqlite3_column_text","_sqlite3_column_type","_sqlite3_data_count","_sqlite3_declare_vtab","_sqlite3_errmsg","_sqlite3_exec","_sqlite3_finalize","_sqlite3_free","_sqlite3_get_autocommit","_sqlite3_libversion","_sqlite3_libversion_number","_sqlite3_limit","_sqlite3_malloc","_sqlite3_open_v2","_sqlite3_prepare_v2","_sqlite3_reset","_sqlite3_sql","_sqlite3_step","_sqlite3_result_blob","_sqlite3_result_double","_sqlite3_result_error","_sqlite3_result_int","_sqlite3_result_int64","_sqlite3_result_null","_sqlite3_result_text","_sqlite3_value_blob","_sqlite3_value_bytes","_sqlite3_value_double","_sqlite3_value_int","_sqlite3_value_int64","_sqlite3_value_text","_sqlite3_value_type","_sqlite3_vfs_find","_set_authorizer","_create_function","_create_module","_progress_handler","_register_vfs","_getSqliteFree","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
// end include: preamble.js
  ...
  function authorizer_method_support() {
  ...
  function progress_method_support() {
  ...
  function _jsProgress() {}

  function _jsStep() {}

  function mod_method_support() {
  ...
  function _modConnect() {}

  function _modCreate() {}

  function _modDestroy() {}

  function _modDisconnect() {}
  ...
  function _vfsCheckReservedLock() {}

  function _vfsClose() {}

  function _vfsDelete() {}

  function _vfsDeviceCharacteristics() {}

  function _vfsFileControl() {}

  function _vfsFileSize() {}
  ...
  function _vfsSectorSize() {}

  function _vfsSync() {}

  function _vfsTruncate() {}
  ...
  instrumentWasmImports:function(imports) {
        var importPatterns = [/^modCreate$/,/^modConnect$/,/^modBestIndex$/,/^modDisconnect$/,/^modDestroy$/,/^modOpen$/,/^modClose$/,/^modFilter$/,/^modNext$/,/^modEof$/,/^modColumn$/,/^modRowid$/,/^modUpdate$/,/^modBegin$/,/^modSync$/,/^modCommit$/,/^modRollback$/,/^modFindFunction$/,/^modRename$/,/^vfsClose$/,/^vfsRead$/,/^vfsWrite$/,/^vfsTruncate$/,/^vfsSync$/,/^vfsFileSize$/,/^vfsLock$/,/^vfsUnlock$/,/^vfsCheckReservedLock$/,/^vfsFileControl$/,/^vfsSectorSize$/,/^vfsDeviceCharacteristics$/,/^vfsOpen$/,/^vfsDelete$/,/^vfsAccess$/,/^invoke_.*$/,/^fd_sync$/,/^__wasi_fd_sync$/,/^__asyncjs__.*$/,/^emscripten_promise_await$/,/^emscripten_idb_load$/,/^emscripten_idb_store$/,/^emscripten_idb_delete$/,/^emscripten_idb_exists$/,/^emscripten_idb_load_blob$/,/^emscripten_idb_store_blob$/,/^emscripten_sleep$/,/^emscripten_wget_data$/,/^emscripten_scan_registers$/,/^emscripten_lazy_load_code$/,/^_load_secondary_module$/,/^emscripten_fiber_swap$/,/^SDL_Delay$/];
...
authorizer_method_support();;
fn_method_support();;
progress_method_support();;
mod_method_support();;
vfs_method_support();;
...
var wasmImports = {
  ...
  jsFinal: _jsFinal,
  jsFunc: _jsFunc,
  jsProgress: _jsProgress,
  jsStep: _jsStep,
  modBegin: _modBegin,
  modBestIndex: _modBestIndex,
  modClose: _modClose,
  modColumn: _modColumn,
  modCommit: _modCommit,
  modConnect: _modConnect,
  modCreate: _modCreate,
  modDestroy: _modDestroy,
  modDisconnect: _modDisconnect,
  modEof: _modEof,
  modFilter: _modFilter,
  modNext: _modNext,
  modOpen: _modOpen,
  modRename: _modRename,
  modRollback: _modRollback,
  modRowid: _modRowid,
  modStruct: _modStruct,
  modSync: _modSync,
  modUpdate: _modUpdate,
  vfsAccess: _vfsAccess,
  vfsCheckReservedLock: _vfsCheckReservedLock,
  vfsClose: _vfsClose,
  vfsDelete: _vfsDelete,
  vfsDeviceCharacteristics: _vfsDeviceCharacteristics,
  vfsFileControl: _vfsFileControl,
  vfsFileSize: _vfsFileSize,
  vfsLock: _vfsLock,
  vfsOpen: _vfsOpen,
  vfsRead: _vfsRead,
  vfsSectorSize: _vfsSectorSize,
  vfsSync: _vfsSync,
  vfsTruncate: _vfsTruncate,
  vfsUnlock: _vfsUnlock,
  vfsWrite: _vfsWrite
};
...
/** @type {function(...*):?} */
var _set_authorizer = Module['_set_authorizer'] = createExportWrapper("set_authorizer");
/** @type {function(...*):?} */
var _create_function = Module['_create_function'] = createExportWrapper("create_function");
/** @type {function(...*):?} */
var _create_module = Module['_create_module'] = createExportWrapper("create_module");
/** @type {function(...*):?} */
var _progress_handler = Module['_progress_handler'] = createExportWrapper("progress_handler");
/** @type {function(...*):?} */
var _register_vfs = Module['_register_vfs'] = createExportWrapper("register_vfs");
/** @type {function(...*):?} */
